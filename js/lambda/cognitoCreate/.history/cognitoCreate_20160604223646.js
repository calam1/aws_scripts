module.exports.handler = function(event, context) {
  ...
  // buildCognitoUserAndIdentityPools(event, sendResponse(event, context, "SUCCESS"));
  buildCognitoUserAndIdentityPools(event);
}
...
function buildCognitoUserAndIdentityPools(event) {
        ...
        if (err) {
          ...
          cognitoidentity.createIdentityPool(params, function(err, data) {
            if (err) {
              ...
              console.log(data);
              return cb(event, context, "SUCCESS");
            }
          });
        }
      });
